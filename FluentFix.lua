...
local Themes = {
	...
	["Amethyst Gravity"] = {
		...
		Accent = Color3.fromRGB(250, 80, 80), 
		...
		InElementBorder = Color3.fromRGB(250, 80, 80),
		...
		DialogInputLine = Color3.fromRGB(250, 80, 80),
...
Components.Window = (function()
	...
	return function(Config)
		...
		local Icon = New("TextButton", {
			...
			New("ImageLabel", {
				Image = "rbxassetid://128972793928157",
				Size = UDim2.new(1, 0, 1, 0),
				BackgroundTransparency = 1,
			}, {
	...
	function Element:New(Idx, Config)
		...
		Creator.AddSignal(ButtonFrame.Frame.MouseButton1Click, function()
			if Button.CallbackFunc then
				Library:SafeCallback(Button.CallbackFunc)
			end
		end)
...
function Library:CreateWindow(Config)
    ...
    local MinimizeButton = New("TextButton", {
        ...
        New("ImageLabel", {
            Image = Config.MinimizerIcon or "rbxassetid://128972793928157",
            Size = UDim2.new(1, 0, 1, 0),
            BackgroundTransparency = 1,
        }, {
            New("UIAspectRatioConstraint", {
